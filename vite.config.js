...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "CMS Agency",
        short_name: "CMS Agency",
        description:
          "CMS Agency is a platform designed to efficiently manage and organize content for landing pages, ensuring seamless updates and a professional web presence.",
        theme_color: "#FEBD0AFF",
        icons: [
          {
